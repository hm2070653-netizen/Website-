      ...
      <section className="hero">
        <div className="wrap hero-inner">
          <div className="hero-copy">
            ...
            <h1>Helping UK Tradespeople <span className="hl">Dominate Google</span> <span className="u">&amp;</span> Win More Local Jobs</h1>
      ...
      <section className="final" id="contact">
        <div className="wrap">
          ...
          <div className="final-cta">
            <Link to="/contact" className="btn btn-primary">Start Getting Leads <span className="arr">↗</span></Link>
